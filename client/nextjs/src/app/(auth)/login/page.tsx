...
import { AlertCircle, ArrowLeft, Eye, EyeOff, Loader2, ShieldCheck, User } from "lucide-react";
...
const STAFF_DOMAIN = "nitte.edu.in";
        ...
        <div className="max-w-md w-full p-8 rounded-3xl border border-border/50 bg-card text-center space-y-6 shadow-lg">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              This deployment is running in <strong>Docs-Only Mode</strong> for the npm registry & showcase. To run full authentication, user management, and database sessions locally, run:
            </p>
          </div>
        ...
        <div className="mx-auto w-full max-w-sm">
          ...
          <div className="mt-8 space-y-6">
            ...
            <button
              ...
              className="group relative flex h-11 w-full justify-center items-center gap-3 rounded-xl border border-input bg-background px-4 text-sm font-medium shadow-sm transition-all hover:bg-accent hover:text-accent-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
            >
              {isGoogleLoading ? (
          ...
          <div className="mt-12 mb-12 text-center text-xs text-muted-foreground leading-relaxed">
